...
# From what is documented here : https://mypy.readthedocs.io/en/latest/type_narrowing.html I would have expected the code to work. The issue seems to be that `Mapping` is a subtype of `Collection`, and `mypy` does not correctly narrow the type.