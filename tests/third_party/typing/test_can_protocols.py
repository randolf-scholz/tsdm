...
def test_can_self_overloaded_protocol() -> None:
    ...
    def test_assign(
        ...
        _z2: CanSelfOP_Union = b_impl  # ❌️: mypy, pyright, pyrefly, ty
        _z3: CanSelfOP_Union = b_self  # ❌️: mypy, pyright, pyrefly, ty
        _z4: CanSelfOP_Union = c_impl  # ❌️: mypy, pyright, pyrefly, ty
        _z5: CanSelfOP_Union = c_self  # ❌️: mypy, pyright, pyrefly, ty
