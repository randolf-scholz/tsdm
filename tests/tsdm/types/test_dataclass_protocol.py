...
def test_dataclass_protocol() -> None:
    ...
    assert issubclass(MyDataclass, Dataclass)  # type: ignore
    assert issubclass(Dataclass, Dataclass)  # type: ignore
...
def test_not_dataclass() -> None:
    ...
    assert not issubclass(NotDataclass, Dataclass)  # type: ignore
