...
class Fork[
    ...
    @overload  # n=1
    def __init__[U, V1](self: Fork[U, tuple[V1]], e: Encoder[U, V1], /, *, reduction: Reduction[tuple[U], U] = ...) -> None: ...
    @overload  # n=2
...
# fmt: off
@overload  # n=0
def fork() -> Fork[object, tuple[()]]: ...
@overload  # n=1
def fork[X, Y1](e: Encoder[X, Y1], /) -> Fork[X, tuple[Y1]]: ...
@overload  # n=2
...
class Meet[TupleIn: tuple, Y, E: Encoder = Encoder](EncoderList[TupleIn, Y, E]):
    ...
    @overload  # n=1
    def __init__[U1, V](self: Meet[tuple[U1], V], e1: Encoder[U1, V], /, *, reduction: Reduction[tuple[V], V] = ...) -> None: ...
    @overload  # n=2
