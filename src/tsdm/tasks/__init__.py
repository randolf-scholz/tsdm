...
from tsdm.tasks.mimic_iii import MIMIC_III_DeBrouwer
from tsdm.tasks.mimic_iv import MIMIC_IV_Bilos
...
TASKS: Final[dict[str, type[Task]]] = {
    ...
    "MIMIC_DeBrouwer": MIMIC_III_DeBrouwer,
    "MIMIC_IV_Bilos": MIMIC_IV_Bilos,
