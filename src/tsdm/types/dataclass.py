...
class _DataclassMeta(ProtocolMeta):
    ...
    def __instancecheck__(cls, instance: object, /) -> TypeIs[Dataclass]:  # pyright: ignore[reportIncompatibleMethodOverride]  # noqa: N805
        return cls.__subclasscheck__(type(instance))

    def __subclasscheck__(cls, subclass: type, /) -> TypeIs[type[Dataclass]]:  # pyright: ignore[reportIncompatibleMethodOverride]  # noqa: N805
