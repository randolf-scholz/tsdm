...
@runtime_checkable
class SupportsInequality[Scalar](Protocol):
...
@runtime_checkable
class NumericalArray[Scalar](SupportsInequality[Scalar], Protocol):
...
@runtime_checkable
class BooleanArray[T: BoolScalar = bool](
    BaseArray,
    SupportsInequality[T | bool],
    Protocol,
):
...
class TimedeltaArray[T: Any = DurationScalar](
    BaseArray,
    SupportsInequality[T | timedelta],
    Protocol,
):
...
class NumericalTensor[Scalar](NumericalArray[Scalar], Protocol):
    ...
    @overload
    def argmin(self, axis: None = ..., /) -> IntScalar: ...
    @overload
    def argmin(self, axis: int, /) -> Self: ...
    @overload
    def argmax(self, axis: None = ..., /) -> IntScalar: ...
    @overload
