...
from tsdm.types.scalars import BoolScalar, OrderedScalar
...
@runtime_checkable
class NumericalArray[Compat](Protocol):  # -Compat, ±Scalar
    ...
    def __ne__(self, other: object, /) -> Self: ...  # type: ignore[override]
    # less than or equal <=
    def __le__(self, other: Self | Compat, /) -> Self: ...
    # greater than or equal >=
    def __ge__(self, other: Self | Compat, /) -> Self: ...
    # less than <
    def __lt__(self, other: Self | Compat, /) -> Self: ...
    # greater than >
    def __gt__(self, other: Self | Compat, /) -> Self: ...
    ...
    # arithmetic
    # addition +
    def __add__(self, other: Self | Compat, /) -> Self: ...
    def __radd__(self, other: Self | Compat, /) -> Self: ...
    # subtraction -
    def __sub__(self, other: Self | Compat, /) -> Self: ...
    def __rsub__(self, other: Self | Compat, /) -> Self: ...
    # multiplication *
    def __mul__(self, other: Self | Compat, /) -> Self: ...
    def __rmul__(self, other: Self | Compat, /) -> Self: ...
    # true division /
    def __truediv__(self, other: Self | Compat, /) -> Self: ...
    def __rtruediv__(self, other: Self | Compat, /) -> Self: ...
    # floor division //
    def __floordiv__(self, other: Self | Compat, /) -> Self: ...
    def __rfloordiv__(self, other: Self | Compat, /) -> Self: ...
    # power **
    # NOTE: arrow/polars does not support complex data types!
    def __pow__(self, exponent: Self | float, /) -> Self: ...
    def __rpow__(self, base: Self | float, /) -> Self: ...
    # modulo %
    def __mod__(self, other: Self | Compat | float, /) -> Self: ...
    def __rmod__(self, other: Self | Compat | float, /) -> Self: ...
    ...
    # boolean operations
    # AND &
    def __and__(self, other: Self | Compat, /) -> Self: ...
    def __rand__(self, other: Self | Compat, /) -> Self: ...
    # OR |
    def __or__(self, other: Self | Compat, /) -> Self: ...
    def __ror__(self, other: Self | Compat, /) -> Self: ...
    # XOR ^
    def __xor__(self, other: Self | Compat, /) -> Self: ...
    def __rxor__(self, other: Self | Compat, /) -> Self: ...
