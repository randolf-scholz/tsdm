...
class IntegerArray[T](
    # BaseArray,
    SupportsVectorComparison[float],
    Protocol,
):
...
@runtime_checkable
class DurationArray[T: DurationScalar = Any](
    BaseArray,
    SupportsVectorComparison[T],
    Protocol,
):
    ...
    def __rsub__(self, other: Self | T, /) -> Self: ...
...
@runtime_checkable
class TimedeltaArrray[T: DurationScalar = Any](DurationArray[T | timedelta], Protocol):
    r"""Protocol for timedelta array-like types supporting standard timedelta operations."""


@runtime_checkable
class TimestampArray[T: TimestampScalar = Any, Dual: DurationScalar = Any](
    BaseArray,
    SupportsVectorComparison[T],
    Protocol,
):
    ...
    def __sub__(self, other: Self | T, /) -> Dual: ...
    def __rsub__(self, other: Self | T, /) -> Dual: ...


@runtime_checkable
class DatetimeArray[T: Any = TimestampScalar, Dual: DurationScalar = Any](
    TimestampArray[T | datetime, Dual | timedelta],
    Protocol,
):
